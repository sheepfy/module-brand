...
class Placeholder implements LocalInterface
{
    ...
    public function getUrl()
    {
        if ($this->getFilePath() !== null) {
            ...
            $result = $this->assetRepo->getUrl("Blacksheep_Brand::images/brand/placeholder/{$this->type}.jpg");
        }
    ...
    public function getPath()
    {
        if ($this->getFilePath() !== null) {
            ...
            $defaultPlaceholder = $this->assetRepo->createAsset(
                "Blacksheep_Brand::images/brand/placeholder/{$this->type}.jpg"
            );
            try {
    ...
    public function getFilePath()
    {
        ...
        $isConfigPlaceholder = $this->scopeConfig->getValue(
            "catalog/placeholder/brand_{$this->type}_placeholder",
